...
<script type="application/ld+json">
{
  ...
  <?php foreach ($products as $product) { ?>
  {
    ...
    "itemOffered": {
      ...
      "image": "<?php echo $product['product_thumb']; ?>"
    },
    "priceSpecification" : {
    ...
    <?php  $i++; if ($i != count($products) ) { echo ","; } } ?>
...
<div style="width: 680px;"><a href="<?php echo $store_url; ?>" title="<?php echo $store_name; ?>"><img src="<?php echo $logo; ?>" alt="<?php echo $store_name; ?>" style="margin-bottom: 20px; border: none;" /></a>
  ...
  <table style="border-collapse: collapse; width: 100%; border-top: 1px solid #DDDDDD; border-left: 1px solid #DDDDDD; margin-bottom: 20px;">
    ...
    <tbody>
      <?php foreach ($products as $product) { ?>
      <tr>
        <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: center; padding: 7px;"><img src="<?php echo $product['product_thumb']; ?>" alt="<?php echo $product['name']; ?>"></td>
