<div class="row">
  ...
  <div class="col-sm-6">
      <fieldset id="type_of_customer">
          ...
          <div class="form-group company_type">
              <label class="col-sm-4 control-label"><?php echo $entry_customer_type; ?></label>
              <div class="col-sm-8">
                  <label for="company_type_answer" class="radio-inline">
                      <input id='individual_client' type="radio" name="document_type" value="0" <?php if($document_type == 0 || !isset($document_type)) echo "checked=\"checked\""?> />
                      <?php echo $text_client; ?>
                  </label>
                  <label class="radio-inline">
                      <input id='company' type="radio" name="document_type" value="1" <?php if($document_type == 1) echo "checked=\"checked\""?> />
    ...
    <fieldset id="address">
      ...
      <div id="company_data">
          ...
          <div class="form-group">
            <label class="control-label" for="input-payment-nip"><?php echo $entry_nip; ?></label>
...
$(document).ready(function(){
    $("#company_data").hide();
    if ($("#company_type_answer:checked").length > 0){ $("#company_data").show(); }
