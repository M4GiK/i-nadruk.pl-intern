  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      <div class="row">
        ...
        <?php $class = 'col-sm-6'; ?>
        <?php } ?>
        <div class="col-2 col-sm-6" itemtype="http://schema.org/WebPage" itemscope="">
			  ...
			  <div class="ratings">
				  <div class="rating-box" itemprop="aggregateRating" itemscope="" itemtype="http://schema.org/AggregateRating">
					  <?php for ($i = 0; $i <= 5; $i++) { ?>
						  <?php if ($rating == $i) {
							  $class_r= "rating".$i;
							  echo '<div class="'.$class_r.'" itemprop="ratingValue">'.$i.' / 5</div>';

						  } 
					  } ?>
                  <span class="hide-element" itemprop="bestRating">5</span>
                  <span class="hide-element" itemprop="reviewCount"><?php echo $reviews_amount; ?></span>
				  </div>
			  </div>
			<?php } ?>
			<?php if ($price) { ?>
              ...
              <div id="input-option<?php echo $option['product_option_id']; ?>" class="btn-group" data-toggle="buttons">
                <?php foreach ($option['product_option_value'] as $option_value) { ?>
                  <label class="btn btn-default">
                    <input type="radio" name="option[<?php echo $option['product_option_id']; ?>]" value="<?php echo $option_value['product_option_value_id']; ?>" autocomplete="off" />
          ...
          <?php if ($tags) { ?>
            ...
            <script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-55111b534d920c54"></script>
            <!-- Go to www.addthis.com/dashboard to customize your tools --> <div class="addthis_inline_share_toolbox_fvix"></div>
            <!-- AddThis Button END -->
        </div>
      </div>
	  <div class="col-3">
...
$('#button-cart').on('click', function() {
	$.ajax({
		...
		type: 'post',
		data: $('input[name=\'product_id\'], #input-quantity, .form-group input[type=\'text\'], .form-group input[type=\'hidden\'], .form-group input[type=\'radio\']:checked, .form-group input[type=\'checkbox\']:checked, .form-group select, .form-group textarea'),
		dataType: 'json',
		beforeSend: function() {
