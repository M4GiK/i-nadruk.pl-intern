    ...
    <div id="content" class="<?php echo $class; ?>"> <?php echo $content_top; ?>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        ...
        <?php if ($customer_type) { ?>
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-nip"><?php echo $entry_nip; ?></label>
            <div class="col-sm-10">
                <input type="text" name="nip" value="<?php echo $nip; ?>" placeholder="<?php echo $entry_nip; ?>" id="input-nip" class="form-control" />
        ...
        <?php if ($customer_type) { ?>
          <div class="form-group">
            <label class="col-sm-2 control-label"><?php echo $entry_company_address; ?></label>
            <div class="col-sm-10">
                <?php if ($company_address) { ?>
                    <label class="radio-inline">
                        <input id="company" type="radio" name="company_address" value="1" checked="checked" />
                        <?php echo $text_yes; ?></label>
                    <label class="radio-inline">
                        <input id="individual_client" type="radio" name="company_address" value="0" />
                        <?php echo $text_no; ?></label>
                <?php } else { ?>
                    <label class="radio-inline">
                        <input id="company" type="radio" name="company_address" value="1" />
                        <?php echo $text_yes; ?></label>
                    <label class="radio-inline">
                        <input id="individual_client" type="radio" name="company_address" value="0" checked="checked" />
                        <?php echo $text_no; ?></label>
                <?php } ?>
            </div>
          </div>
