      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <label for="company_type_answer" class="radio-inline">
                <input id='individual_client' type="radio" name="customer_type" value="0" checked="checked" />
                <?php echo $text_client; ?>
              </label>
              <label class="radio-inline">
                <input id='company' type="radio" name="customer_type" value="1" />
        ...
        <fieldset id="address">
          ...
          <div id="company_data">
            ...
            <div class="form-group">
              <label class="col-sm-2 control-label" for="input-company-nip"><?php echo $entry_nip; ?></label>
              <div class="col-sm-10">
