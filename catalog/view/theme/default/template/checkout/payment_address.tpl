<form class="form-horizontal">
  <?php if ($addresses) { ?>
    <?php if ($customer_info['customer_type'] != 0 && isset($customer_info['customer_type'])) { ?>
  <fieldset id="type_of_bill">
    <legend><?php echo $text_type_of_bill; ?></legend>
    <div class="form-group">
      <label class="col-sm-2 control-label"><?php echo $entry_bill_type; ?></label>
      <div class="col-sm-10">
        <label class="radio-inline">
          <input type="radio" name="document_type" value="0" <?php if($document_type == 0 || !isset($document_type)) echo "checked=\"checked\""?> />
          <?php echo $text_receipt; ?>
        </label>
        <label class="radio-inline">
          <input type="radio" name="document_type" value="1" <?php if($document_type == 1) echo "checked=\"checked\""?> />
              <?php echo $text_vat_invoice; ?>
        </label>
      </div>
    </div>
  </fieldset>
  <br>
  <fieldset>
      <legend><?php echo $text_data_to_bill; ?></legend>
      <div class="radio">
          <label>
          ...
          <select name="address_id" class="form-control">
              <?php foreach ($addresses as $address) { ?>
                  <?php if ($address['address_id'] == $address_id) { ?>
                      <option value="<?php echo $address['address_id']; ?>" selected="selected"><?php echo $address['company']; ?>, <?php echo $address['address_1']; ?>, <?php echo $address['city']; ?>, <?php echo $address['zone']; ?>, <?php echo $address['country']; ?></option>
                  <?php } else { ?>
                      <option value="<?php echo $address['address_id']; ?>"><?php echo $address['company']; ?>, <?php echo $address['address_1']; ?>, <?php echo $address['city']; ?>, <?php echo $address['zone']; ?>, <?php echo $address['country']; ?></option>
                  <?php } ?>
              <?php } ?>
          </select>
      </div>
  ...
  <div id="payment-new" style="display: <?php echo ($addresses ? 'none' : 'block'); ?>;">
    ...
    <?php if ($customer_info['document_type'] != 0 && isset($customer_info['document_type'])) { ?>
    <div class="form-group">
    ...
    <div class="form-group">
      <label class="col-sm-2 control-label" for="input-payment-nip"><?php echo $entry_nip; ?></label>
      <div class="col-sm-10">
          <input type="text" name="nip" value="" placeholder="<?php echo $entry_nip; ?>" id="input-payment-nip" class="form-control" />
      </div>
    </div>
    <?php } ?>
    <div class="form-group required">
