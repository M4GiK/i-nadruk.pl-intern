<div id="search-by-category">
	<div class="search-container">
		<div class="categories-container">
			...
			<p class="search-all"><span class="cate-selected" data-value="0"><?php echo $text_category; ?></span></p>
	...
	<div class="search-ajax">
		<div class="ajax-loader-container" style="display: none;">
			<img src="<?php echo $ocsearchcategory_loader_img ?>" class="ajax-load-img" width="30" height="30" alt="kamstechnologies.pl" />
		</div>
